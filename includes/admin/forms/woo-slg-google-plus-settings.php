				...
				<div class="handlediv" title="<?php _e( 'Click to toggle', 'wooslg' ); ?>"><br /></div>
					...
					<table class="form-table">
						<tbody>
							...
							<tr valign="top">
								<th scope="row">
									<label for="woo_slg_gp_redirect_url"><?php echo __( 'Google JavaScript origins URL:', 'wooslg' ); ?></label>
								</th>
								<td>
							...
							<tr>
								<td colspan="4">
									<p class="woo-slg-error-box"><?php echo __( 'Note: Before using the Google social login, update the <strong>Authorized JavaScript origins</strong> in Google App setting, as mentioned in the document', 'wooslg' ); ?> <a href="https://wpweb.co.in/documents/social-network-integration/google/#google-javascript-origins" target="_blank"><?php echo __( 'here', 'wooslg' ); ?></a>.</p>
								</td>
							</tr>

							<tr>
								<th scope="row">
									<label for="woo_slg_enable_gp_avatar"><?php _e( 'Enable Google Avatar:', 'wooslg' ); ?></label>
								</th>
								<td>
									...
									<label for="woo_slg_enable_gp_avatar"><?php echo __( 'Check this box, if you want to use Google profile pictures as avatars.', 'wooslg' ); ?></label>
								</td>
							</tr>
