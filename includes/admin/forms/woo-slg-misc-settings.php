				...
				<div class="handlediv" title="<?php _e( 'Click to toggle', 'wooslg' ); ?>"><br /></div>
					...
					<table class="form-table">
						<tbody>
							...
							<tr>
								<th scope="row">
									<label for="woo_slg_public_js_unique_version"><?php _e( 'Caching:', 'wooslg' ); ?></label>
								</th>
								<td>
									...
									<span class="description"><label for="woo_slg_public_js_unique_version"><?php echo __( 'Check this box, if you use a caching plugin','wooslg' ); ?></label></span>
								</td>
							</tr>
