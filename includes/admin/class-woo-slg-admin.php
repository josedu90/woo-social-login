...
class WOO_Slg_Admin {
    ...
    public function woo_slg_settings_save() {
        ...
        if (isset($_POST['woo-slg-set-submit']) && !empty($_POST['woo-slg-set-submit'])) {
            ...
            $woo_slg_mail_subject = ( isset($_POST['woo_slg_mail_subject']) && !empty($_POST['woo_slg_mail_subject']) ) ? $_POST['woo_slg_mail_subject'] : __('Verify your account', 'wooslg');
            $woo_slg_mail_content = ( isset($_POST['woo_slg_mail_content']) && !empty($_POST['woo_slg_mail_content']) ) ? $_POST['woo_slg_mail_content'] : __('Please click {verify_link} to verify your email address and complete the registration process.', 'wooslg');
...
//                        $woo_slg_mail_content = get_option('woo_slg_mail_content');
                        ...
                        foreach ($system_info['plugins'] as $plugin) {
                            ...
                            if (!empty($plugin['name'])) {
                                ...
                                $log_data .= "\n" . $plugin_name . __(' by ', 'wooslg') . $plugin['author_name'] . ' - ' . esc_html($plugin['version']) . $version_string . $network_string;
                            }
                        }
