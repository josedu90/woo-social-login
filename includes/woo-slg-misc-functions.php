...
function woo_slg_messages() {
    ...
    return apply_filters('woo_slg_messages', array(
        ...
        'gperrormsg' => __('Please enter Google Client ID in settings page.', 'wooslg'),
        ...
        'emailerrormsg' => __('Please enter Vaild Email.', 'wooslg'),
        'emailverifymmsg' => __( '<strong>Success:</strong> Your account has been activated!', 'wooslg' ), // added for verify user message
    ));
}
