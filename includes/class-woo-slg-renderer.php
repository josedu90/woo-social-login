...
class WOO_Slg_Renderer {
	...
	public function woo_slg_wrapper_login_with_email_content() {
		...
		if( $enable_login_with_email == 'yes' ) {
			...
			$login_email_placeholder = (!empty($woo_slg_options['woo_slg_login_email_placeholder'])) ? $woo_slg_options['woo_slg_login_email_placeholder'] : __('Enter your email address', 'wooslg') ;

			$login_btn_text = (!empty($woo_slg_options['woo_slg_login_btn_text'])) ? $woo_slg_options['woo_slg_login_btn_text'] : __('Sign in', 'wooslg');
	...
	public function woo_slg_gdpr_privacy_notice() {
		...
		if ( !empty($woo_slg_options['woo_slg_enable_gdpr']) && ($woo_slg_options['woo_slg_enable_gdpr']=='yes') && !empty($woo_slg_options['woo_slg_gdpr_privacy_page']) && !empty($woo_slg_options['woo_slg_gdpr_privacy_policy']) ) {
			...
			$privacy_page_link = '<a href="'.get_permalink($privacy_page_id).'" class="wooslg-privacy-policy-link" target="_blank">'. __('privacy policy','wooslg').'</a>';
