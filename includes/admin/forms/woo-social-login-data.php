		...
		<table class="wp-list-table woo-slg-sortable widefat">
			<thead>
				<tr>
					...
					?>
					<th class="col-network column-primary"><?php _e( 'Network', 'wooslg');?></th>
					<?php
			...
			<tbody>
				...
				?>
					<tr class="<?php print $drag_class;?>">
						...
						?>
						<td class="woo-slg-netowrk-<?php echo $key; ?> woo-slg-table-col column-primary" data-colname="<?php _e( 'Network', 'wooslg');?>"><img src="<?php echo WOO_SLG_IMG_URL.'/backend/images/'.$key.'.png';?>" alt="<?php echo $value;?>" />
							<button type="button" class="toggle-row"><span class="screen-reader-text"><?php _e( 'Show more details', 'wooslg');?></span></button>
						</td>
						<?php
							//do action to add social table data network
							do_action( 'woo_slg_social_table_data_network_after', $key, $value );
						?>
						<td class="woo-slg-table-col reg-count-label" data-colname="<?php _e( 'Register Count', 'wooslg');?>"><?php echo $regusers[$key]['count'];?></td>
						<?php
							//do action to add social table data reg count after
							do_action( 'woo_slg_social_table_data_reg_count_after', $key, $value );
						?>
						<td class="woo-slg-table-col" data-colname="<?php _e( 'Status', 'wooslg');?>">
							<?php
						...
						?>
						<td style="<?php print $email_style;?>"><a href="<?php echo $redirect_uri ?>" class="button"><?php _e('Settings', 'wooslg'); ?></a></td>
						<?php
							//do action to add social table data reg count after
